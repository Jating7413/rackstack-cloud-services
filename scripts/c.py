...
commands.getstatusoutput("chmod +x /webcontent/database/user2.c ")
valid = commands.getstatusoutput("gcc -o /webcontent/database/user2 /webcontent/database/user2.c")
if valid[0] == 0:
	output =  commands.getoutput("/webcontent/database/user2")
